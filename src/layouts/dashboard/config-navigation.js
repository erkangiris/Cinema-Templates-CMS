    ...
    () => [
      ...
      // ----------------------------------------------------------------------
      {
        items: [
          ...
          { title: t('branchs'), path: paths.dashboard.branchs.root, icon: ICONS.menuItem },
          // { title: t('siteSettings'), path: paths.dashboard.general.settings, icon: ICONS.ecommerce },
      ...
      // ----------------------------------------------------------------------
      {
        ...
        items: [
          // Content Settings
          {
            ...
            path: paths.dashboard.managamet.root,
            icon: ICONS.folder,
            children: [
              ...
              { title: t('news'), path: paths.dashboard.managamet.news.root },
            ],
          },

          {
            ...
            icon: ICONS.user,
            children: [
              { title: t('bulten'), path: paths.dashboard.members.elbuten },
            ],
          },
