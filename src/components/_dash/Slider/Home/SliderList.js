...
export default function UserListView({data}) {
  ...
  const TABLE_HEAD = [
    { id: 'title', label: t('name'), width: 700  },
    { id: 'date', label: t('date'), width: 500  },
    { id: 'img', label: t('img'), width: 600 },
  ...
  const handleDeleteRow = useCallback(
    (id) => {
      ...
      WebServices.DeleteSlider({Id:id})
  ...
  const handleEditRow = useCallback(
    (id) => {
      router.push(paths.dashboard.managamet.slider.edit(id));
    },
    [router]
  );
